...
public class MainWindowController implements BoatStatProgramViewController {
    ...
    {
        showInputViewButton.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/Mata_in.png"))));
        showStatViewButton.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/Statistics.png"))));
    }
